      ...
      <Splash
        title={
          <div>
            ...
            <div className="text-[40px] md:text-[30px] w-5/6 lg:text-[50px] xl:text-[60px] font-semibold leading-[40px] md:leading-[30px] lg:leading-[50px] xl:leading-[60px] mb-12">
              <div className="text-[24px] lg:text-[44px] leading-10">Book an</div>
              Appointment
            </div>
          </div>
        }
        ...
        <div className="flex flex-col md:flex-row">
          <div className="flex-3 order-1 md:order-0 py-12 bg-linear-to-b from-white via-white to-gray-200">
            <div className="w-full px-8 text-center md:text-right">
              <div className="text-[18px] md:text-[32px] font-bold text-sky-700 mb-2">Call us Today</div>
          ...
          <div className="flex-3 px-8 order-0 md:order-1 py-12 pb-[50px] md:pb-[100px] bg-linear-to-b from-sky-900 to-sky-950 text-center md:text-left">
            <div className="text-[18px] md:text-[32px] font-bold text-white mb-2">Schedule an Appointment</div>
